...
export const calculateKPIs = (metrics: MetricRecord[]): CalculatedMetrics => {
  ...
  return {
    ...
    cost_per_appointment_booked: safeDivide(totals.ad_spend, (totals.appointments_booked || 0) + (totals.live_transfers || 0) + (totals.self_booked || 0) + (totals.sales_team_booked || 0)),
